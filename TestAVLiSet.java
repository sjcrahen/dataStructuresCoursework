...
public class TestAVLiSet {

    public static void main(String[] args) {
      
      AVLIntegerSet set = new AVLIntegerSet();
      
      for (int i = 1; i <= 15; i++) {
        set.add(i);
      }
      
      System.out.println(set.levelOrderToString());
      System.out.println(set.magnitude());
...
//      System.out.println("*********************************************************");
//      
//      AVLIntegerSet2 iSet = new AVLIntegerSet2();
//      
...
//      System.out.println("*********************************************************");
//      
//      AVLIntegerSet2 iSet2 = new AVLIntegerSet2();
//      iSet2.add(1);
//      iSet2.add(2);
//      iSet2.add(3);
//      iSet2.add(4);
...
//      AVLIntegerSet2 unionSet = iSet.union(iSet2);
...
//      System.out.println("IntegerSet 1: " + iSet.toString());
//      System.out.println("IntegerSet 2: " + iSet2.toString());
//      AVLIntegerSet2 intersectionSet = iSet.intersection(iSet2);
