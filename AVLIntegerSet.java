...
public class AVLIntegerSet {
  ...
  public AVLIntegerSet union(AVLIntegerSet other) {
    AVLIntegerSet unionSet = new AVLIntegerSet();
  ...
  public AVLIntegerSet intersection(AVLIntegerSet other) {
    AVLIntegerSet intersectionSet = new AVLIntegerSet();
